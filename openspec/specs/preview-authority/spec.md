...
SDL preview uses a transformation-state-machine driven pipeline where input commands flow through authoritative state before manifestation, ensuring preview rendering always reflects the canonical sprite state.
