...
A preview executable that loads a GSPL sprite package, renders the current manifestation (2D/2.5D/3D), drives the living runtime, and displays a debug overlay.
