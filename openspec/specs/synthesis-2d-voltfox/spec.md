# synthesis-2d-voltfox

## Purpose

Generate 2D sprite frames from morphology definitions, rendering each body part as a distinct 2D primitive with form-specific visuals, collision shape data, and animation timing metadata.
