...
Project adapters persist the canonical normalized requirement set separately
from the compatibility report. Their verifier reparses those requirements,
re-evaluates the registered adapter, compares the canonical report exactly, and
